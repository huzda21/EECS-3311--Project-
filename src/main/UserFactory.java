...
public class UserFactory {
    ...
    private static abstract class UserCreator {
        abstract User createUser(String id, String email, String password,
                                  boolean isVerified, Long idNumber);
 
        User register(String id, String email, String password,
                       boolean isVerified, Long idNumber) {
    ...
    public static User createUser(String accountType, String id, String email,
                                   String password, boolean isVerified, Long idNumber) {
